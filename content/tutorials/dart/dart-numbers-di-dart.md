...
+++
## Apa itu Numbers ?
Pasti kalian sudah tidak asing dengan keyword tersebut, yak tipe data numbers atau tipe data angka. Pada bahasa Dart tipe data number sendiri ada 2 yaitu :
1. int (Integer)
2. Double (Float)
